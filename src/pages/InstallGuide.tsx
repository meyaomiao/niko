      ...
      <div className="mx-auto max-w-lg">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400">
            {BRAND.name} Windows 版当前未购买代码签名证书，首次安装时会触发 SmartScreen 保护提示。
        ...
        <ol className="space-y-5">
          <Step num={1} title="下载安装包">
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
              从 GitHub Releases 下载最新的 <code className="rounded bg-black/[0.04] dark:bg-white/10 px-1 text-gray-700 dark:text-gray-300">*.msi</code> 或{" "}
              <code className="rounded bg-black/[0.04] dark:bg-white/10 px-1 text-gray-700 dark:text-gray-300">*_setup.exe</code> 文件。
          ...
          <Step num={2} title="运行安装包，出现 SmartScreen 弹窗">
            <div className="mt-2 rounded-xl border border-blue-500/30 bg-blue-500/5 p-4">
              <p className="text-xs font-semibold text-blue-700 dark:text-blue-300">📘 提示</p>
          ...
          <Step num={4} title='点击"仍要运行"完成安装'>
            <p className="text-xs text-gray-500 dark:text-gray-400 dark:text-gray-400">
              点击展开后出现的
              <span className="mx-1 font-medium text-gray-800 dark:text-gray-200">仍要运行</span>
              按钮，安装程序将正常启动。之后按提示完成安装即可。
            </p>
          </Step>
        </ol>

        <div className="mt-8 rounded-xl border border-black/5 dark:border-white/10 bg-white dark:bg-white/5 p-4 text-xs text-gray-500 dark:text-gray-400">
          <p className="font-medium text-gray-500 dark:text-gray-400 dark:text-gray-400">为什么没有签名？</p>
          <p className="mt-1">
